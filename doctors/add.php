...
<html lang="en">
	...
	<head>
		...
		<title>Add Doctor- Tide Hospitals</title>
	</head>
...
<?php
	if($con)
	{
		if(isset($_POST['submit']))
		{
			...
			mysqli_query($link,"insert into doctor values($id,'$name','$special','$email',$number,'$address')");
			...
			<h1 class='text-center' style='margin-top: 10vh'>
				DOCTOR ADDED 
				<br>
				<i class='fa fa-stethoscope' style='color:red'></i>
			</h1>
			<br>
			";
