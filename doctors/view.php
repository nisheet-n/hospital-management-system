...
<html lang="en">
	...
	<head>
		...
		<title>View Doctor- Tide Hospitals</title>
	</head>
...
<?php
	if($con)
	{
		if(isset($_POST['submit1']))
		{
			...
			$doc_list=mysqli_query($link, "select * from doctor where DOC_ID=$id and EMAIL='$email'");
		...
		{
			$doc_list=mysqli_query($link, "select DOC_NAME, EMAIL, SPECIALISATION from doctor");
